export const LEAGUE_CONVERSION_RATES: Record<string, number> = {
    'EPL': 0.33, 'LA_LIGA': 0.31, 'SERIE_A': 0.29,
    'BUNDESLIGA': 0.35, 'LIGUE_1': 0.30, 'STANDARD': 0.31
};
...
export const FOOTBALL_DATA_CONFIG = {
    ...
    LEAGUE_MAP: { 'EPL': 'E0', 'LA_LIGA': 'SP1', 'SERIE_A': 'I1', 'BUNDESLIGA': 'D1', 'LIGUE_1': 'F1' } as Record<string, string>
};
